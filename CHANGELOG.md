...
- The setting for `CACHES` is now present in the project settings, grabbing the value from the environment variable `CACHE_URL` and defaulting to the local memory.
